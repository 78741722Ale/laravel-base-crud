        ...
        <div class="row flex_cent_2 w-100 h-100">
            ...
            <form class="w-50 h-75" action="{{route('comics.store')}}" method="post">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="cover_image" name="cover_image" class="form-control @error('cover_image') is-invalid @enderror pb-1" value="{{old('title')}}" placeholder="https://myimage.png" aria-describedby="coverImageHelper">
                    <!-- Error -->
                    @error('cover_image')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="author" name="author" class="form-control @error('author') is-invalid @enderror pb-1" value="{{old('title')}}" placeholder="Nome Autore" aria-describedby="authorHelper">
                    <!-- Error -->
                    @error('author')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control @error('info') is-invalid @enderror pb-1" id="info" name="info" placeholder="Info" value="{{old('title')}}" aria-describedby="infoHelper"></textarea>
                    <!-- Error -->
                    @error('info')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="price" name="price" class="form-control" placeholder="Prezzo" value="{{old('title')}}" aria-describedby="priceHelper">
                    <!-- Error -->
                    @error('price')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
